...
//     version 1.8.2
//     from Assets/_Project/Scripts/Player/PlayerInputControls.inputactions
//
...
public partial class @PlayerInputControls: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerInputControls()
    {
        Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, PlayerInputControls.Player.Disable() has not been called.");
        Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, PlayerInputControls.UI.Disable() has not been called.");
    }
